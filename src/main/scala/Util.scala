...
class Util extends Serializable
{
  ...
  def readOrder(path:String)=                                                    //e-com
  {
    var rows = ArrayBuffer[Array[String]]()
  ...
  def readOrder2(path:String)=                                                       //O2O
  {
    var rows = ArrayBuffer[Array[String]]()
  ...
  def readCourier(path:String)=                                                             //courier
  {
    var rows = ArrayBuffer[Array[String]]()
  ...
  def readRecord(path:String)=                                                //initial solution
  {
    var rows = ArrayBuffer[Array[String]]()
  ...
  def getMin(time_str:String):Int=                         //get the time difference from 8:00
  {
  ...
  def dist(spot1:String,spot2:String,points_set:Map[String,Point_id]):Int=            //get distance between two sites
  { 
    var lat1,lat2,lng1,lng2=200.0
    var id1=""
    var id2=""
  ...
  def point_dist(lat1:Double,lng1:Double,lat2:Double,lng2:Double):Int=                 //get distance between two points
  {
    ...
    def serv(num_ord:Int):Int=                                //length of service
  {
    if(num_ord >0)
