...
class Plan extends Serializable
{
	...
	def init(records:Array[Record],points_set:Map[String,Point_id],site_points:Map[String,Point_id],shop_points:Map[String,Point_id],his_tabu:Array[String],tabu_list_length:Int)=                               //读取初始???
    {
    	var util=new Util()
    ...
    def transform():Array[(Int,Record)]=                                //将solution转换为关于Record的数???
    {
    ...
    def totalcost(f_orders:Map[String,Order],e_orders:Map[String,Order_2]):(Double,Map[String,Array[Int]],Map[String,Array[String]],String)=               //计算solution的总cost
    {
    	var total=0.0
    ...
    def change(id:String,path:Path):Array[Path]=                                  //用path替换solution中的cid为id的Path
    {
    ...
    def select_Path(id:String)=                                     //返回solution中cid为id的Path
    {
    	var path=new Path(id)
    ...
    def copy_solution():Plan=                                              //复制当前solution
    {
    	var copy=new Plan()
    ...
    def order_swap(pathrcid:Path,pathid:Path,rc_id:String,r1:String,id:String,r2:Int):(Path,Path,String)=
    {
    	...
    	{
    		var tmp=Record(path_id.cid,r1)                                          //交换两个订单
    ...
    def swap(rc_id:String,r1:String,id:String,r2:Int,f_orders:Map[String,Order],e_orders:Map[String,Order_2],move_num:Int):(Int,Double,String)=
    {
    	...
    	val oldcost=path_rcid.cost(f_orders,e_orders,penal,E_list,points,0)._1+path_id.cost(f_orders,e_orders,penal,E_list,points,0)._1      //两个快递员原本的cost之和
        ...
        {  
        	...
        	var type_of_solution=""
        	var discost=rcid_new._1+id_new._1-oldcost         //交换后与交换前的cost之差
        	...
        	return (1,rcid_exceed+id_exceed,"infeasible")                                                                         //int最?????
    }

    def insert(id:String,removevalue:String,r2:Int,f_orders:Map[String,Order],e_orders:Map[String,Order_2],offset:Int,removevalue2:String):(Int,Double,String)=                                   //mod,第二条记录与第一条记录之间的偏移
    {
	...
	def operator_choose_ori(r1:String,rc_id:String,f_orders:Map[String,Order],e_orders:Map[String,Order_2],c_id:Array[Courier],ratio:Int,time_list:Map[String,Array[Int]],address_list:Map[String,Array[String]],operator_mode:String):(Double,Array[Path],Map[String,Array[Int]],Map[String,Array[String]],String)=
	{
		/*if(r1.charAt(0)=='F')
		{
			var path_rcid=select_Path(rc_id)
